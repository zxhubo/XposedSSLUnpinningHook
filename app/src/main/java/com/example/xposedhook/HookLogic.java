...
import com.example.xposedhook.module.Okhttp3;
...
//        }
        ...
        // add code
        List<String> hostAppPackages = new ArrayList<>();
        hostAppPackages.add("com.oppo.market");
        if (hostAppPackages.contains(loadPackageParam.packageName)){
            XposedBridge.log("Hook "+ loadPackageParam.packageName);
            Okhttp3.byPass(loadPackageParam.classLoader);
        }
    }
